...
// get Nx,Ny,Nz away from cube, compute Ncube based on that.
// then refine (bfc, Pc, No) as needed
...
// entrance
Point(57) = {entrance,0     ,-span/2};
Point(58) = {entrance,0     , span/2};
Point(59) = {entrance,height,-span/2};
Point(60) = {entrance,height, span/2};

// Wake
Point(61) = {wake,0     ,-span/2};
Point(62) = {wake,0     , span/2};
Point(63) = {wake,height,-span/2};
Point(64) = {wake,height, span/2};
...
//Line Loop(91)={-141,145,142,-15,-14}; Plane Surface(91) = {91};
//Line Loop(92)={-141,145,142,-15,-14}; Plane Surface(92) = {92};
//
//Transfinite Surface {91}; Recombine Surface {91};
//Transfinite Surface {92}; Recombine Surface {92};
...
//Line Loop(96)={-141,145,142,-15,-14}; Plane Surface(96) = {96};
//Line Loop(97)={-141,145,142,-15,-14}; Plane Surface(97) = {97};
//
//Transfinite Surface {96}; Recombine Surface {96};
//Transfinite Surface {97}; Recombine Surface {97};
